...
public class Vector3 {
    ...
    public Vector3 reflectIn(Vector3 N) {
        // T (this normalised) + R (reflected normalised) = 2 N (normal normalised) cos theta
        // as this means that the components of T and R perpendicular to the normal are 0, and the parralel
        // components are both N cos theta
        // this can then be rearranged to give R = 2(N.T)N - T
        // which is this below
